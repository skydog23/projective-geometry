...
public class AndroidTopLevelAppearance {
	...
	public AndroidTopLevelAppearance(Appearance ap)	{
		rootAp = ap;
...
//		}
		...
		if (obj instanceof Boolean) AndroidRenderingState.useOldTransparency = ((Boolean)obj).booleanValue();
