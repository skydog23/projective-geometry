...
public class AndroidOffscreenRenderer {
	...
	private AndroidRenderer jr;
	
	public AndroidOffscreenRenderer(AndroidRenderer jr)	{
		this.jr = jr;
	}
	...
	public BufferedImage renderOffscreen(int imageWidth, int imageHeight, GLAutoDrawable canvas) {
		if (!GLDrawableFactory.getFactory().canCreateGLPbuffer()) {
			AndroidConfiguration.getLogger().log(Level.WARNING,"PBuffers not supported");
			return null;
		}
