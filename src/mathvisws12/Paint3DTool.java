...
public class Paint3DTool extends AbstractTool {

	final int imageSize = 1024;
	final int brushSize = 32;
	final Color initialColor = new Color(1f, 1f, 1f, 1f);//.5f,.5f,.5f,1f);
	boolean lighting = false;
	Graphics2D g2d ;
	JRViewer jrv;
	public Paint3DTool(Appearance ap, JRViewer jrviewer)	{
	...
	private void updateBrush(Color brushColor) {
		...
		public Component getInspector()	{
			...
			jcc.getSelectionModel().addChangeListener( new ChangeListener() {
				...
				public void stateChanged(ChangeEvent arg0) {
					lineColor = jcc.getColor();
					updateBrush(lineColor);
				}
