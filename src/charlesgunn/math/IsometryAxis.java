...
public class IsometryAxis {
	...
	public IsometryAxis(Biquaternion axis, Biquaternion angle) {
		fromLog = true;
	}
	...
	public Biquaternion exp(double t)	{
		...
		if (isTranslation)	{
			...
			} else if (isometry.getMetric() == Metric.EUCLIDEAN)	{
			...
			double[] cossin = Biquaternion.cossin(null, t*angle.qr.re, t*angle.qd.re, isometry.getMetric());
			Biquaternion scalar2 = new Biquaternion(cossin[2], cossin[3], isometry.getMetric());
