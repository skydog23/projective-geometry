...
//		IndexedFaceSet ifs = ifsf.getIndexedFaceSet();
		...
		SceneGraphComponent firstInstance = new SceneGraphComponent("plane2");
		SceneGraphComponent secondInstance = new SceneGraphComponent("plane2");
		firstInstance.addChild(oneNP);
		secondInstance.addChild(oneNP);
		world.addChildren(firstInstance, secondInstance);
		MatrixBuilder.euclidean().rotateX(Math.PI/8).translate(2.2,0,0).assignTo(secondInstance);
