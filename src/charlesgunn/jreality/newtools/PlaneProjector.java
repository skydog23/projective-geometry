...
public class PlaneProjector extends Projector {
	...
	public void setDefaultPlane()	{
		...
		Rn.matrixTimesVector(imageOfOrigin, objectToCam, P3.originP3);
		// project onto z-axis
		imageOfOrigin[0] = imageOfOrigin[1] = 0d;
		distanceToPlane = Pn.distanceBetween(imageOfOrigin, P3.originP3, Pn.EUCLIDEAN); //theViewer.getMetric());
